...
def dashboard():
    ...
    return render_template('dashboard.html', posts = posts, loggedUser=loggedUser, savedposts = loggedUserSavedPost)
...
def buy():
    ...
    return render_template('concern.html', posts = posts, loggedUser=loggedUser, savedposts = loggedUserSavedPost)
...
def sell():
    ...
    return render_template('myconcern.html', posts = posts, loggedUser=loggedUser, savedposts = loggedUserSavedPost)
